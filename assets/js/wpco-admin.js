(function ($) {
    ...
    $(
        function () {
            ...
            $(document).on(
                "click", ".wpco-fields-add-btn", function () {
                    let field_type_option = "";

                    $.each(
                        wpco_types, function (key, val) {
                            field_type_option +=
            ...
            $(document).on(
                "click", ".wpco-group-delete-btn", function () {
                    $(this).closest(".wpco-panel-section").remove();
                }
            );

            $(document).on(
                "click", ".wpco-field-delete-btn", function () {
